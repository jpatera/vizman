...
ALTER TABLE  vizman.cfgprop
	ADD "TYPE" VARCHAR(20)
;

ALTER TABLE  vizman.cfgprop
	ADD VALUE_DECIMAL DECIMAL(20,2)
;	

COMMIT;


ALTER TABLE  vizman.calym
	ADD CALY_ID BIGINT
;	

UPDATE vizman.CALYM cym
SET CALY_ID = (SELECT id FROM vizman.caly WHERE cym.ym / 100 = yr)
;

ALTER TABLE  vizman.calym
	ADD CONSTRAINT FK_CALYM_CALYT FOREIGN KEY (CALY_ID) REFERENCES VIZMAN.CALY(ID) ON DELETE RESTRICT ON UPDATE RESTRICT
;	
