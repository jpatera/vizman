...
-- =================================================================================
--  Create tables - PERSON, ROLE, PERSON_ROLE, PERSON_SALARY, ROLE_PERM
-- =================================================================================
...
--  PERSON_SALARY
------------------------------------
DROP TABLE VIZMAN.PERSON_SALARY IF EXISTS
;

CREATE TABLE VIZMAN.PERSON_SALARY (
	ID BIGINT NOT NULL,
	VERSION INTEGER NOT NULL,
	PERSON_ID BIGINT NOT NULL,
	USERNAME VARCHAR,
	...
	YM_TO INTEGER,
	SALARY DECIMAL,
	CONSTRAINT PK_PERSONSALARY PRIMARY KEY (ID),
	CONSTRAINT FK_PERSONSALARY_PERSON FOREIGN KEY (PERSON_ID) REFERENCES VIZMAN.PERSON(ID) ON DELETE RESTRICT ON UPDATE RESTRICT
);
...
-----------------------------------------
--  Salaries - INSERT to PERSON_SALARY
-----------------------------------------

INSERT INTO VIZMAN.PERSON_SALARY
	(ID, VERSION,
	 PERSON_ID,
	 USERNAME,
	 YM_FROM, YM_TO,
...
CREATE UNIQUE INDEX IDXQ_PERSONSALARY_PERSONID_YMFROM
	ON VIZMAN.PERSON_SALARY (PERSON_ID, YM_FROM)
;
...
-- 113
SELECT COUNT(*) FROM VIZMAN.PERSON_SALARY;
