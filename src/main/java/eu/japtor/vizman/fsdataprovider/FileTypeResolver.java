...
public class FileTypeResolver  implements Serializable {
     ...
     */
    private static Icon DEFAULT_ICON = new Icon(VaadinIcon.FILE_O);
...
//            return icon;
//        }
        if (mimeType.contains("font")) return new Icon(VaadinIcon.FILE_FONT);
        if (mimeType.contains("html")) return new Icon(VaadinIcon.FILE_CODE);
        if (mimeType.contains("css")) return new Icon(VaadinIcon.FILE_CODE);
        if (mimeType.contains("java")) return new Icon(VaadinIcon.FILE_CODE);
        if (mimeType.contains("c++")) return new Icon(VaadinIcon.FILE_CODE);
        if (mimeType.contains("excel")) return new Icon(VaadinIcon.FILE_TABLE);
        if (mimeType.contains("word")) return new Icon(VaadinIcon.FILE_TEXT_O);
        if (mimeType.contains("powerpoint")) return new Icon(VaadinIcon.FILE_PRESENTATION);
        if (mimeType.contains("zip")) return new Icon(VaadinIcon.FILE_ZIP);
        if (mimeType.contains("pdf")) return new Icon(VaadinIcon.FILE_TEXT_O);
        if (mimeType.startsWith("audio")) return new Icon(VaadinIcon.FILE_SOUND);
        if (mimeType.startsWith("image")) return new Icon(VaadinIcon.FILE_PICTURE);
        if (mimeType.startsWith("text")) return new Icon(VaadinIcon.FILE_TEXT_O);
        if (mimeType.startsWith("video")) return new Icon(VaadinIcon.FILE_MOVIE);
        if (mimeType.startsWith("inode/drive")) return new Icon(VaadinIcon.HARDDRIVE_O);
        if (mimeType.startsWith("inode/directory")) return new Icon(VaadinIcon.FOLDER);
        if (mimeType.startsWith("inode/symlink")) return new Icon(VaadinIcon.FOLDER_O);
