...
//        );
        ...
        subFormDialog = new SubFormDialog(
                this::saveSubForForm, this::deleteSubForForm
        );
...
//                fakts.add(0, savedFakt);
            ...
            // TODO:
            //            if (faktsChanged || (OperationResult.NO_CHANGE != faktOperRes)) {
            binder.removeBean();
            binder.readBean(currentItem);
//            }
