...
import eu.japtor.vizman.ui.components.ExpXlsButtonAnchor;
import eu.japtor.vizman.ui.components.ReportXlsExporter;
...
public class UserVykazSimpleDialog extends AbstractGridDialog<ZaknNaklVw> implements HasLogger {
     ...
     */
    public UserVykazSimpleDialog(ZakNaklVwService zakNaklVwService) {
        super(DIALOG_WIDTH, DIALOG_HEIGHT);
        setItemNames(ItemType.UNKNOWN);
        getMainTitle().setText("VÝKAZ PRÁCE");
