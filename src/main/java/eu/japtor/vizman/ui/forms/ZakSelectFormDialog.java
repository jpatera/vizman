...
//public class ZakSelectFormDialog<KzTreeAware> extends Dialog {
public class ZakSelectFormDialog extends Dialog {

    private static final String SEL_COL_KEY = "sel-col";
    ...
    public ZakSelectFormDialog(Consumer<List<KzTreeAware>> itemSelector, KontService kontService)
    {
