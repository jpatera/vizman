...
public class NabFolderField extends TextField implements HasLogger {
...
//                ConfirmDialog
//                        .createWarning()
//                        .withCaption("Dokumentový adresář nabídky")
//                        .withMessage("Složka kontraktu není definována, nelze pracovat s nabídkový adresáři")
//                        .open();
////                return;
...
//                        .createWarning()
//                        .withCaption("Dokumentový adresář nabídky")
//                        .withMessage("Složka nabídky není definována")
//                        .open();
////                return;
//            } else {
//                openDir("Dokumentový adresář nabídky"
//                        , Paths.get(docRoot
...
//                ConfirmDialog
//                        .createWarning()
//                        .withCaption("Projektový adresář nabídky")
//                        .withMessage("Složka kontraktu není definována, nelze pracovat s nabídkovými adresáři")
//                        .open();
////                return;
//            } else if (StringUtils.isBlank(this.getValue())) {
//                ConfirmDialog
...
////                return;
//            } else {
//                openDir("Projektový adresář nabídky"
//                        , Paths.get(projRoot
//                                , null == parentFolder ? "" : parentFolder
//                                , this.getValue()
//                        )
