...
//                .findFirst().orElse(null);
    ...
    private void updatePruhGrids(final Person pruhPerson, final YearMonth ym) {
        ...
        monthHourFondComponent.setText(null == monthHourFond ? "" : VzmFormatUtils.DEC_HOD_FORMAT.format(monthHourFond));
...
//        pruhZakGrid.setHeight("100%");
        ...
        pruhZakGrid.addColumn(ckzTextRenderer)
...
//            .setTextAlign(ColumnTextAlign.END)
        ...
        Binder<PruhZak> pzEditorBinder = pzEditor.getBinder();
...
//                    pzEditor.getItem().setValueToDayField(day
                    ...
                    if (!StringUtils.isBlank(event.getValue())) {
                        ...
                        decHod = new BigDecimal(newVal);
                        editComp.setValue(null == decHod ? "" : VzmFormatUtils.DEC_HOD_FORMAT.format(decHod));
                    }

                    pzEditor.getItem().setHod(day, decHod);
                    missingHodsFooterRow.getCell(col).setText(getMissingHodString(day));
...
//                .set("width", HOD_COL_WIDTH)
        ...
        pzEditorBinder.forField(editComp)
                ...
                .withConverter(VzmFormatUtils.VALIDATED_DEC_HOD_TO_STRING_CONVERTER)    // ..when  entering/leaving edit mode
...
//        });
    ...
    private String getMissingHodString(int day) {
        ...
        return (null == missingHods || missingHods.compareTo(BigDecimal.ZERO) == 0) ?
                "" : VzmFormatUtils.DEC_HOD_FORMAT.format(missingHods);
    }
    ...
    private String getSumHodString(int day) {
        ...
        return (null == sumHods || sumHods.compareTo(BigDecimal.ZERO) == 0) ?
                "" : VzmFormatUtils.DEC_HOD_FORMAT.format(sumHods);
    }
