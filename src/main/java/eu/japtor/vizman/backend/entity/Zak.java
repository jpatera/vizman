...
@Entity
//@Table(name = "ZAK", schema = "VIZMAN", catalog = "TEST")
//@Table(name = "ZAK", schema = "VIZMAN")
@Table(name = "ZAK")
@SequenceGenerator(initialValue = 1, name = "id_gen", sequenceName = "zak_seq")
public class Zak extends AbstractEntity {

    private String cisloZakazky;
    private Integer idZakazky;
...
//    }
    ...
    @Basic
    @Column(name = "CISLO_ZAKAZKY")
    public String getCisloZakazky() {
        return cisloZakazky;
    }

    public void setCisloZakazky(String cisloZakazky) {
        this.cisloZakazky = cisloZakazky;
    }

    @Basic
    @Column(name = "ID_ZAKAZKY")
    public Integer getIdZakazky() {
        return idZakazky;
    }

    public void setIdZakazky(Integer idZakazky) {
