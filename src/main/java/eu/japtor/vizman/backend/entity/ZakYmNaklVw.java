...
//@ReadOnly
@Entity
@Table(name = "ZAK_YM_NAKL_VIEW")
public class ZakYmNaklVw implements Serializable {
...
//    @OrderBy("cfakt DESC")
    ...
    public void setWorkPruh(BigDecimal workPruh) {
        this.workPruh = workPruh;
    }

    public BigDecimal getKoefP8() {
        return koefP8;
    }
    public void setKoefP8(BigDecimal koefP8) {
        this.koefP8 = koefP8;
    }
    ...
    public void setWorkP8(BigDecimal workP8) {
        this.workP8 = workP8;
    }
    ...
    @Transient
    private Long personIdTrans;

    public Long getPersonIdTrans() {
        return personIdTrans;
    }
    public void setPersonIdTrans(Long personIdTrans) {
        this.personIdTrans = personIdTrans;
    }
...
//        return null == naklMzda ? null : naklMzda.multiply(koefRezie.add(BigDecimal.ONE));
    ...
    public boolean equals(Object other) {
        ...
        return id != null && id.equals(((ZakYmNaklVw) other).id);
    }
}
