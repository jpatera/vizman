...
/**
 Vypis rocni dochazky
 */
public class DochYearXlsReportBuilder extends FastReportBuilder {

    private AbstractColumn personId;
    private AbstractColumn fullNameAndDochYear;
    ...
    public DochYearXlsReportBuilder() {
        super();
    ...
    private void buildReportGroups() {
        ...
        userGroup = new GroupBuilder()
                .setCriteriaColumn((PropertyColumn) fullNameAndDochYear)
                .setGroupLayout(GroupLayout.VALUE_IN_HEADER)
                .setStartInNewPage(true)
                .setFooterLabel(new DJGroupLabel("Celkem", GROUP_HEADER_WEEK_STYLE, LabelPosition.LEFT))
    ...
    private void buildReportColumns() {
        ...
        fullNameAndDochYear = ColumnBuilder.getNew()
