...
//    private AbstractColumn faktBlankCol2;
//    private AbstractColumn faktBlankCol3;
//    private AbstractColumn faktBlankCol4;
//    private AbstractColumn faktBlankCol5;
//    private AbstractColumn faktBlankCol6;
...
//                .addColumn(faktBlankCol4)
//                .addColumn(faktBlankCol5)
...
//                .addColumn(faktBlankCol2)
//                .addColumn(faktBlankCol3)
//                .addColumn(faktBlankCol4)
//                .addColumn(faktBlankCol5)
//                .addColumn(faktBlankCol6)
                .addColumn(cfaktCol)
...
//                .build();
//        faktBlankCol2 = ColumnBuilder.getNew()
//                .setCustomExpression(new BlankExpression())
//                .build();
//        faktBlankCol3 = ColumnBuilder.getNew()
//                .setCustomExpression(new BlankExpression())
//                .build();
//        faktBlankCol4 = ColumnBuilder.getNew()
//                .setCustomExpression(new BlankExpression())
//                .build();
//        faktBlankCol5 = ColumnBuilder.getNew()
//                .setCustomExpression(new BlankExpression())
//                .build();
//        faktBlankCol6 = ColumnBuilder.getNew()
//                .setCustomExpression(new BlankExpression())
//                .build();
    }
